...
def btn2Action():
    ...
    def btnGTAVAction():
        try:
            if varchk.get() == 2:
                ...
                directory = str(dlg.askdirectory(title='Selecione o diretório da configuração'))
    ...
    def btnValorantAction():
        try:
            if varchk.get() == 6:
                ...
                directory = str(dlg.askdirectory(title='Selecione o diretório da configuração', initialdir=(f'C:/Users/{user}/AppData/Local/VALORANT/Saved/Config')))
    ...
    def btnLOLAction():
        if varchk.get() == 12:
            if os.path.isdir(r"C:\Riot Games\League of Legends\Config"):
                destiny = r"C:\Riot Games\League of Legends\Config"
                if os.path.isfile(fr"{destiny}\game.cfg"):
                    with open(fr"{destiny}\game.cfg", "w+") as file:
                        file.write(
                            '[FloatingText]\n'
                            'Special_Enabled=1\n'
                            'Score_Enabled=1\n'
                            ...
                            'MasterVolume=0.3000\n'
                            'MasterMute=0\n'
                            'AnnouncerVolume=0.3000\n'
                            'AnnouncerMute=0\n'
                            'AmbienceVolume=0.3000\n'
                            'AmbienceMute=0\n'
                            '\n'
                            '[MapSkinOptions]\n'
                ...
                dialog = str(dlg.askdirectory(title='Selecione o diretório da configuração', initialdir=('C:')))
                directory = dialog + f"\game.cfg"
            ...
            if os.path.isdir(r"C:\Riot Games\League of Legends\Config"):
                ...
                tk.messagebox.showinfo('Operação Concluída', 'Sua Configuração foi modificada com sucesso !\n :)')
    def btnMinecraftAction():
        if varchk.get() == 14:
            if os.path.isdir(fr"C:\Users\{user}\AppData\Roaming\.minecraft"):
                destiny  = fr"C:\Users\{user}\AppData\Roaming\.minecraft"
                if os.path.isfile(f"{destiny}\options.txt"):
                    with open(fr"{destiny}\options.txt", "w+") as file:
                        file.write(
                            'version:3120\n'
                            'autoJump:true\n'
                            ...
                            'fov:0.5\n'
                            'screenEffectScale:0.20422535211267606\n'
                            'fovEffectScale:0.04315859948422932\n'
                    ...
                    with open(fr"{destiny}\optionsof.txt", "w+") as file:
                        file.write(
                            'ofFogType:2\n'
                            'ofFogStart:0.8\n'
                            'ofMipmapType:0\n'
                ...
                dialog = str(dlg.askdirectory(title='Selecione o diretório da configuração', initialdir=(f'C:/Users/{user}/AppData')))
                with open(fr"{dialog}\options.txt", "w+") as file:
                    file.write(
                        'version:3120\n'
                        'autoJump:true\n'
                        'autoSuggestions:true\n'
                ...
                with open(fr"{dialog}\optionsof.txt", "w+") as file:
                    file.write(
                        'ofFogType:2\n'
                        'ofFogStart:0.8\n'
                        'ofMipmapType:0\n'
    ...
    chk13 = ttk.Radiobutton(frame1,
    text="Pc Fraco",
    value=12,
    variable=varchk)

    chk14 = ttk.Radiobutton(frame1,
    text="Pc Forte",
    value=13,
    variable=varchk)

    chk15 = ttk.Radiobutton(frame1,
    text="Pc Fraco",
    value=14,
    variable=varchk)

    chk16 = ttk.Radiobutton(frame1,
    text="Pc Forte",
    value=15,
    variable=varchk)
    ...
    btnLol = ttk.Button(frame1,
    text=(emoji.emojize(":engrenagem:Modificar Configuração", language="pt")),
    width=22,
    command=btnLOLAction)

    btnMinecraft = ttk.Button(frame1,
    text=(emoji.emojize(":engrenagem:Modificar Configuração", language="pt")),
    width=22,
    command=btnMinecraftAction)
    ...
    chk13.place(x=210, y=515)
    chk14.place(x=211, y=545)
    btnLol.place(x=165, y=580)
    chk15.place(x=610, y=515)
    chk16.place(x=611, y=545)
    btnMinecraft.place(x=565, y=580)
...
app.title("KOCKIE OPTIMIZER V0.9")
