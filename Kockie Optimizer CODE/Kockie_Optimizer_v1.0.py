...
def btn2Action():
    ...
    def btnWarzone2Action():
        if varchk.get() == 16:
            if os.path.isdir(fr'C:\Users\{user}\Documents\Call of Duty\players'):
                destiny = fr'C:\Users\{user}\Documents\Call of Duty\players\options.3.cod22.cst'
                if(os.path.isfile(destiny)):
                    with open(destiny, 'w+') as file:
                        file.write(
                            ...
                            'EffectsVolume:0.0 = "0.380000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// Adjusts the volume of hit markers\n'
                            'HitMarkersVolume:0.0 = "0.380000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// Licensed Music Volume\n'
                            'LicensedMusicVolume:0.0 = "1.000000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// Adjusts the volume of the music\n'
                            'MusicVolume:0.0 = "0.400000" // 0.000000 to 1.000000\n'
                            '\n'
                            ...
                            'VoiceVolume:0.0 = "0.440000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// Adjusts overall volume of the game\n'
                            'Volume:0.0 = "0.440000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// War Tracks Volume\n'
                            ...
                            'AMDSuperResolutionQuality:0.0 = "Ultra Quality" // one of [Maximum Performance, Balanced, Maximum Quality, Ultra Quality]\n'
                            '\n'
                            ...
                            'CorpsesCullingThreshold:0.0 = "0.750000" // 0.500000 to 1.000000\n'
                            '\n'
                            '// Default SMAA technique\n'
                            'DefaultSMAATechnique:0.0 = "SMAA T2x" // one of [SMAA T2x, Filmic SMAA T2x]\n'
                            '\n'
                            ...
                            'GPUName:0.0 = "NVIDIA GeForce GTX 1060 3GB"\n'
                            '\n'
                            '// GTAO Quality level\n'
                            ...
                            'NVIDIAImageScalingQuality:0.0 = "Ultra Quality" // one of [Maximum Performance, Balanced, Maximum Quality, Ultra Quality, Custom, Native Quality]\n'
                            '\n'
                            '// NVIDIA Image Scaling sharpness\n'
                            'NVIDIAImageScalingSharpness:0.0 = "1.000000" // 0.000000 to 1.000000\n'
                            '\n'
                            '// Particle Lighting Quality\n'
                            'ParticleLighting:0.0 = "2" // 0 to 5\n'
                            '\n'
                            '// Particle Quality quality level\n'
                            'ParticleQualityLevel:0.0 = "medium" // one of [very low, low, medium, high]\n'
                            '\n'
                            ...
                            'ReflectionProbeRelighting:0.0 = "2" // 1 to 4\n'
                            '\n'
                            '// SMAA Quality level\n'
                            ...
                            'ScreenSpaceShadowQuality:0.0 = "Low" // one of [Off, Low, High]\n'
                            '\n'
                            '// Select the shader quality setting\n'
                            'ShaderQuality:0.0 = "Medium" // one of [Default, Medium, Low]\n'
                            '\n'
                            '// Shadow resolution quality level\n'
                            'ShadowMapResolution:1.0 = "Low" // one of [Very Low, Low, Normal, High, Extra, Ultra]\n'
                            '\n'
                            '// Adjust size of Spot Shadow Cache\n'
                            'SpotShadowCacheSize:0.0 = "1" // 0 to 3\n'
                            '\n'
                            ...
                            'TextureFilter:0.0 = "TEXTURE_FILTER_ANISO8X" // one of [TEXTURE_FILTER_NEAREST, TEXTURE_FILTER_LINEAR, TEXTURE_FILTER_ANISO2X, TEXTURE_FILTER_ANISO4X, TEXTURE_FILTER_ANISO8X, TEXTURE_FILTER_ANISO16X, TEXTURE_FILTER_CMP]\n'
                            '\n'
                            ...
                            '\n'
                            '// Volumetric quality\n'
                            'VolumetricQuality:0.0 = "QUALITY_MEDIUM" // one of [QUALITY_LOW, QUALITY_MEDIUM, QUALITY_HIGH]\n'
                            '\n'
                ...
                dialog = str(dlg.askdirectory(title='Selecione o diretório da configuração', initialdir=(f'C:')))
                with open(fr"{dialog}\options.3.cod22.cst", "w+") as file:
                    file.write(
                        '0\n'
                        '\n'
                        '// system settings version.\n'
    ...
    frame2 = ttk.Frame(NewWindow)
    bg2 = PhotoImage(file = "files//Bg4.png")
    background_label=Label(frame2, image=bg2)
    background_label.place(x=0,y=0,relwidth=1,relheight=1)

    chk17 = ttk.Radiobutton(frame2,
    text="Pc Fraco",
    value=16,
    variable=varchk)

    chk18 = ttk.Radiobutton(frame2,
    text="Pc Forte",
    value=17,
    variable=varchk)

    btnWarzone2 = ttk.Button(frame2,
    text=(emoji.emojize(":engrenagem:Modificar Configuração", language="pt")),
    width=22,
    command=btnWarzone2Action)

    chk17.place(x=380, y=320)
    chk18.place(x=381, y=350)
    btnWarzone2.place(x=335, y=385)
    ...
    def btnSeta1Action():
        ...
        if varWin == 0:
            ...
            frame1.place_forget()
            frame2.place(x=0, y=0, width=900, height=677)
            varWin = 0
        else:
            frame.place_forget()
            frame1.place(x=0, y=0, width=900, height=677)
    ...
    btnSeta2.place(x=370, y=625)
    btnSeta1.place(x=445, y=625)
    NewWindow.mainloop()
...
app.title("KOCKIE OPTIMIZER V1.0")
